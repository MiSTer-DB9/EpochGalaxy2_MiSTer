...
UPSTREAM_REPO="https://github.com/MiSTer-devel/EpochGalaxy2_MiSTer.git"
...
UPSTREAM_CORE_NAME=(EpochGalaxyII)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(galaxy.qpf)
COMPILATION_OUTPUT=(output_files/galaxy.rbf)
